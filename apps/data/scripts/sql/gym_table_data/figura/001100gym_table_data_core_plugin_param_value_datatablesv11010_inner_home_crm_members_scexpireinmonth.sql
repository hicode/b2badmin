set my.pluginname to 'datatablesv11010_inner_home_crm_members_scexpireinmonth';
...
update core_plugin_param_value set paramvalue='vfcrmcustomerfullexpiremonth'
    where 
        mykatastima=:mykatastima 
    and 
