set my.pluginname to 'datatablesv11010_inner_home_crm_members_contracts_energa_all';
...
INSERT INTO core_plugin_param_value(
	...
	'trans_table_title','EnergaContracts'
    ),
        (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
...
--    ),
    ...
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
	'datasource+readtblname','vfcrmcustomercontractenergapaymentgroupm'
    ),
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
