set my.pluginname to 'newrecordv100_inner_home_crm_services_new';
...
-- DLS20161107
    ...
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
    'newrecord+portlet+attributes+data-writetbl','corecrmavailableservice'),
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
...
--     'newrecord+fields+40+icon+class','fa-euro'),
    ...
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
    'newrecord+fields+50+label+trans_text','servicetitle'),
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
    ...
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
    'newrecord+fields+50+attributes+name','cc_new_record_service_title'),
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
    'newrecord+fields+50+attributes+data-name','title'),
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
    'newrecord+fields+50+attributes+data-type','simpletext'),
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
    'newrecord+fields+50+attributes+data-title','serviceerrortitle'),
    (:mykatastima,(select id from core_plugin where mykatastima=:mykatastima and pluginname=(SELECT current_setting('my.pluginname'))),
