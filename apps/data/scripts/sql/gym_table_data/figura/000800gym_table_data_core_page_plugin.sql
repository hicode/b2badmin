...
-- DLS20161111
    ...
    -- DLS20161117
    (:mykatastima,
        (select id from core_page where mykatastima=:mykatastima and pagename='inner_home_crm_trainers_new'),
        (select id from core_plugin where mykatastima=:mykatastima and pluginname='newrecordv100_inner_home_crm_trainers_new')
    );
    -- DLE20161117