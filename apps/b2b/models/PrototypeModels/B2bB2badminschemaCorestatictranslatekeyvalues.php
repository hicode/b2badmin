...
abstract class B2bB2badminschemaCorestatictranslatekeyvalues extends \B2b\Models\BaseModel implements B2bB2badminschemaCorestatictranslatekeyvaluesInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorestatictranslatekeyvaluesInterface*/
                        ...
                        *@return B2bB2badminschemaCorestatictranslatekeyvaluesInterface*/
                        ...
                        {      
                            ...
                            /**
                                * @var int
                            */
                            protected $fkstatictranslatekey;
             
                        /**
                        * Get fkstatictranslatekey.
                        * 
                             /**
                                * @return int
                            */  
                    public function getFkstatictranslatekey()
                    {
                        return $this->fkstatictranslatekey;
                    }  /**
                        * Set fkstatictranslatekey.
                        *@param int $fkstatictranslatekey    
                        *@return B2bB2badminschemaCorestatictranslatekeyvaluesInterface*/
                         public function setFkstatictranslatekey($fkstatictranslatekey) 
                        {      
                            $this->fkstatictranslatekey = (int) $fkstatictranslatekey;
                            return $this;
                        }    
                            /**
                                * @var string
    ...
    const CONST_TABLE = "core_static_translate_key_values";
