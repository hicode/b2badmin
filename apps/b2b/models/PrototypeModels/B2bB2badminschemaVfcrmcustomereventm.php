...
abstract class B2bB2badminschemaVfcrmcustomereventm extends \B2b\Models\BaseModel implements B2bB2badminschemaVfcrmcustomereventmInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfcrmcustomereventmInterface*/
    ...
    const CONST_TABLE = "vf_crm_customer_event_m";
