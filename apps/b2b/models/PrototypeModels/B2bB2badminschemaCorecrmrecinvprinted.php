...
abstract class B2bB2badminschemaCorecrmrecinvprinted extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmrecinvprintedInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmrecinvprintedInterface*/
    ...
    const CONST_TABLE = "core_crm_recinv_printed";
