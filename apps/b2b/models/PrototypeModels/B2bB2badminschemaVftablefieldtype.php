...
abstract class B2bB2badminschemaVftablefieldtype extends \B2b\Models\BaseModel implements B2bB2badminschemaVftablefieldtypeInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVftablefieldtypeInterface*/
    ...
    const CONST_TABLE = "vf_tablefieldtype";
