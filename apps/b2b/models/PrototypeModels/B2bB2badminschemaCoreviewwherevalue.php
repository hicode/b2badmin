...
abstract class B2bB2badminschemaCoreviewwherevalue extends \B2b\Models\BaseModel implements B2bB2badminschemaCoreviewwherevalueInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoreviewwherevalueInterface*/
    ...
    const CONST_TABLE = "core_view_where_value";
