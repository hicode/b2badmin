...
abstract class B2bB2badminschemaVfcrmcounters extends \B2b\Models\BaseModel implements B2bB2badminschemaVfcrmcountersInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfcrmcountersInterface*/
    ...
    const CONST_TABLE = "vf_crm_counters";
