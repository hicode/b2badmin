...
abstract class B2bB2badminschemaVfpluginnoavailableparams extends \B2b\Models\BaseModel implements B2bB2badminschemaVfpluginnoavailableparamsInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfpluginnoavailableparamsInterface*/
    ...
    const CONST_TABLE = "vf_plugin_no_available_params";
