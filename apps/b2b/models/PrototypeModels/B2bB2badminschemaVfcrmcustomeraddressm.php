...
abstract class B2bB2badminschemaVfcrmcustomeraddressm extends \B2b\Models\BaseModel implements B2bB2badminschemaVfcrmcustomeraddressmInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfcrmcustomeraddressmInterface*/
    ...
    const CONST_TABLE = "vf_crm_customer_address_m";
