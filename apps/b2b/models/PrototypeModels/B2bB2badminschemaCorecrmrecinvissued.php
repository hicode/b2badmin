...
abstract class B2bB2badminschemaCorecrmrecinvissued extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmrecinvissuedInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmrecinvissuedInterface*/
    ...
    const CONST_TABLE = "core_crm_recinv_issued";
