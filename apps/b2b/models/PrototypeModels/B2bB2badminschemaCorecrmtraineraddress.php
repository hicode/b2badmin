...
abstract class B2bB2badminschemaCorecrmtraineraddress extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmtraineraddressInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmtraineraddressInterface*/
                    ...
                    public function getJobremarks()
                    {
                        ...
                        * 
                             /**
                                * @return int
                            */  
                    public function getFktrainer()
                    {
                        return $this->fktrainer;
                    }  /**
                        * Set fktrainer.
                        *@param int $fktrainer    
                        *@return B2bB2badminschemaCorecrmtraineraddressInterface*/
                         public function setFktrainer($fktrainer) 
                        {      
                            $this->fktrainer = (int) $fktrainer;
                            return $this;
                        }    
                            /**
                                * @var string
    ...
    const CONST_TABLE = "core_crm_trainer_address";
