...
abstract class B2bB2badminschemaCoretablerelation extends \B2b\Models\BaseModel implements B2bB2badminschemaCoretablerelationInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoretablerelationInterface*/
                    ...
                    public function getField2()
                    {
                        ...
                        * 
                             /**
                                * @return int
                            */  
                    public function getFkreltype()
                    {
                        return $this->fkreltype;
                    }  /**
                        * Set fkreltype.
                        *@param int $fkreltype    
                        *@return B2bB2badminschemaCoretablerelationInterface*/
                         public function setFkreltype($fkreltype) 
                        {      
                            $this->fkreltype = (int) $fkreltype;
                            return $this;
                        }
    ...
    const CONST_TABLE = "core_table_relation";
