...
abstract class B2bB2badminschemaCorecrmnotes extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmnotesInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmnotesInterface*/
                    ...
                    public function getBldone()
                    {
                        ...
                        *@param float $bldone    
                        *@return B2bB2badminschemaCorecrmnotesInterface*/
                         public function setBldone($bldone) 
                        {      
                            $this->bldone = (float) $bldone;
                            return $this;
                        }
    ...
    const CONST_TABLE = "core_crm_notes";
