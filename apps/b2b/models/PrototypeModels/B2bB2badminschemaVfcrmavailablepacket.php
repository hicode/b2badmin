...
abstract class B2bB2badminschemaVfcrmavailablepacket extends \B2b\Models\BaseModel implements B2bB2badminschemaVfcrmavailablepacketInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfcrmavailablepacketInterface*/
    ...
    const CONST_TABLE = "vf_crm_available_packet";
