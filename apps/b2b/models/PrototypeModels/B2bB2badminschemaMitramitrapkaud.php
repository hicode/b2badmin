...
abstract class B2bB2badminschemaMitramitrapkaud extends \B2b\Models\BaseModel implements B2bB2badminschemaMitramitrapkaudInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaMitramitrapkaudInterface*/
                    ...
                    public function getDt_aud()
                    {
                        ...
                        *@param string $dt_aud    
                        *@return B2bB2badminschemaMitramitrapkaudInterface*/
                         public function setDt_aud($dt_aud) 
                        {      
                            $this->dt_aud = (string) $dt_aud;
                            return $this;
                        }    
                            /**
                                * @var int
                    ...
                    public function getId_aud()
                    {
                        ...
                        *@param int $id_aud    
                        *@return B2bB2badminschemaMitramitrapkaudInterface*/
                         public function setId_aud($id_aud) 
                        {      
                            $this->id_aud = (int) $id_aud;
                            return $this;
                        }    
                            /**
                                * @var string
                        ...
                        * 
                             /**
                                * @return string
                            */  
                    public function getTbl_aud()
                    {
                        return $this->tbl_aud;
                    }  /**
                        * Set tbl_aud.
                        *@param string $tbl_aud    
                        *@return B2bB2badminschemaMitramitrapkaudInterface*/
                         public function setTbl_aud($tbl_aud) 
                        {      
                            $this->tbl_aud = (string) $tbl_aud;
                            return $this;
                        }
    ...
    const CONST_TABLE = "mitra_mitrapk_aud";
