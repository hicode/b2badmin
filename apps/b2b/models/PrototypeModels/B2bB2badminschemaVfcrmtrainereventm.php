...
abstract class B2bB2badminschemaVfcrmtrainereventm extends \B2b\Models\BaseModel implements B2bB2badminschemaVfcrmtrainereventmInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfcrmtrainereventmInterface*/
    ...
    const CONST_TABLE = "vf_crm_trainer_event_m";
