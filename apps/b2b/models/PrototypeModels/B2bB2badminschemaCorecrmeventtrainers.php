...
abstract class B2bB2badminschemaCorecrmeventtrainers extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmeventtrainersInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmeventtrainersInterface*/
                        ...
                        *@return B2bB2badminschemaCorecrmeventtrainersInterface*/
                        ...
                        {      
                            ...
                            /**
                                * @var int
                            */
                            protected $fkcorecrmtrainer;
             
                        /**
                        * Get fkcorecrmtrainer.
                        * 
                             /**
                                * @return int
                            */  
                    public function getFkcorecrmtrainer()
                    {
                        return $this->fkcorecrmtrainer;
                    }  /**
                        * Set fkcorecrmtrainer.
                        *@param int $fkcorecrmtrainer    
                        *@return B2bB2badminschemaCorecrmeventtrainersInterface*/
                         public function setFkcorecrmtrainer($fkcorecrmtrainer) 
                        {      
                            $this->fkcorecrmtrainer = (int) $fkcorecrmtrainer;
                            return $this;
                        }    
                            /**
                                * @var int
    ...
    const CONST_TABLE = "core_crm_event_trainers";
