...
abstract class B2bB2badminschemaCorevieworder extends \B2b\Models\BaseModel implements B2bB2badminschemaCorevieworderInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorevieworderInterface*/
                    ...
                    public function getOrderoperator()
                    {
                        ...
                        * Set orderoperator.
                        *@param string $orderoperator    
                        *@return B2bB2badminschemaCorevieworderInterface*/
                         public function setOrderoperator($orderoperator) 
                        {      
                            $this->orderoperator = (string) $orderoperator;
                            return $this;
                        }    
                            /**
                                * @var int
    ...
    const CONST_TABLE = "core_view_order";
