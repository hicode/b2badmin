...
abstract class B2bB2badminschemaCoremoduleparamvalue extends \B2b\Models\BaseModel implements B2bB2badminschemaCoremoduleparamvalueInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoremoduleparamvalueInterface*/
                        ...
                        *@return B2bB2badminschemaCoremoduleparamvalueInterface*/
                        ...
                        {      
                            ...
                            /**
                                * @var int
                            */
                            protected $fkavailablemoduleparamvalue;
             
                        /**
                        * Get fkavailablemoduleparamvalue.
                        * 
                             /**
                                * @return int
                            */  
                    public function getFkavailablemoduleparamvalue()
                    {
                        return $this->fkavailablemoduleparamvalue;
                    }  /**
                        * Set fkavailablemoduleparamvalue.
                        *@param int $fkavailablemoduleparamvalue    
                        *@return B2bB2badminschemaCoremoduleparamvalueInterface*/
                         public function setFkavailablemoduleparamvalue($fkavailablemoduleparamvalue) 
                        {      
                            $this->fkavailablemoduleparamvalue = (int) $fkavailablemoduleparamvalue;
                            return $this;
                        }    
                            /**
                                * @var string
    ...
    const CONST_TABLE = "core_module_param_value";
