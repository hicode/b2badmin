...
abstract class B2bB2badminschemaCorestatictranslatekey extends \B2b\Models\BaseModel implements B2bB2badminschemaCorestatictranslatekeyInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorestatictranslatekeyInterface*/
    ...
    const CONST_TABLE = "core_static_translate_key";
