...
abstract class B2bB2badminschemaCoreviewselect extends \B2b\Models\BaseModel implements B2bB2badminschemaCoreviewselectInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoreviewselectInterface*/
    ...
    const CONST_TABLE = "core_view_select";
