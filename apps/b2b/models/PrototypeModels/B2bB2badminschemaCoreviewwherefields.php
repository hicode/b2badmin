...
abstract class B2bB2badminschemaCoreviewwherefields extends \B2b\Models\BaseModel implements B2bB2badminschemaCoreviewwherefieldsInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoreviewwherefieldsInterface*/
    ...
    const CONST_TABLE = "core_view_where_fields";
