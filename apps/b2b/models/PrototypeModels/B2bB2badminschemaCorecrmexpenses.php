...
abstract class B2bB2badminschemaCorecrmexpenses extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmexpensesInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmexpensesInterface*/
    ...
    const CONST_TABLE = "core_crm_expenses";
