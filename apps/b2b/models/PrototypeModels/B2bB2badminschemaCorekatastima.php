...
abstract class B2bB2badminschemaCorekatastima extends \B2b\Models\BaseModel implements B2bB2badminschemaCorekatastimaInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorekatastimaInterface*/
                    ...
                    public function getJobremarks()
                    {
                        ...
                        * 
                             /**
                                * @return string
                            */  
                    public function getMykatastimanum()
                    {
                        return $this->mykatastimanum;
                    }  /**
                        * Set mykatastimanum.
                        *@param string $mykatastimanum    
                        *@return B2bB2badminschemaCorekatastimaInterface*/
                         public function setMykatastimanum($mykatastimanum) 
                        {      
                            $this->mykatastimanum = (string) $mykatastimanum;
                            return $this;
                        }
    ...
    const CONST_TABLE = "core_katastima";
