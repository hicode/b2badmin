...
abstract class B2bB2badminschemaCoretemplateparamvalue extends \B2b\Models\BaseModel implements B2bB2badminschemaCoretemplateparamvalueInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoretemplateparamvalueInterface*/
    ...
    const CONST_TABLE = "core_template_param_value";
