...
abstract class B2bB2badminschemaVfcorecrmnotesbadgecount extends \B2b\Models\BaseModel implements B2bB2badminschemaVfcorecrmnotesbadgecountInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfcorecrmnotesbadgecountInterface*/
    ...
    const CONST_TABLE = "vf_core_crm_notes_badge_count";
