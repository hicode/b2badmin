...
abstract class B2bB2badminschemaVfroutepageplugintranslateavailablepluginjsonm extends \B2b\Models\BaseModel implements B2bB2badminschemaVfroutepageplugintranslateavailablepluginjsonmInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfroutepageplugintranslateavailablepluginjsonmInterface*/
    ...
    const CONST_TABLE = "vf_route_page_plugin_translate_available_plugin_json_m";
