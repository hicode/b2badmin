...
abstract class B2bB2badminschemaCorecrmeventrepeat extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmeventrepeatInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmeventrepeatInterface*/
    ...
    const CONST_TABLE = "core_crm_event_repeat";
