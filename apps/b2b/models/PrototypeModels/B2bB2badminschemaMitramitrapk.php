...
abstract class B2bB2badminschemaMitramitrapk extends \B2b\Models\BaseModel implements B2bB2badminschemaMitramitrapkInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaMitramitrapkInterface*/
    ...
    const CONST_TABLE = "mitra_mitrapk";
