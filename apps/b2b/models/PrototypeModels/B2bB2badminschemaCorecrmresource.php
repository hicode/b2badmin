...
abstract class B2bB2badminschemaCorecrmresource extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmresourceInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmresourceInterface*/
    ...
    const CONST_TABLE = "core_crm_resource";
