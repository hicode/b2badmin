...
abstract class B2bB2badminschemaVfcrmcustomeripoloipa extends \B2b\Models\BaseModel implements B2bB2badminschemaVfcrmcustomeripoloipaInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfcrmcustomeripoloipaInterface*/
    ...
    const CONST_TABLE = "vf_crm_customer_ipoloipa";
