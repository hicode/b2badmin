...
abstract class B2bB2badminschemaCoreavailableexpensestype extends \B2b\Models\BaseModel implements B2bB2badminschemaCoreavailableexpensestypeInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoreavailableexpensestypeInterface*/
    ...
    const CONST_TABLE = "core_available_expenses_type";
