...
abstract class B2bB2badminschemaCorecrmwherefindus extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecrmwherefindusInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecrmwherefindusInterface*/
    ...
    const CONST_TABLE = "core_crm_where_find_us";
