...
abstract class B2bB2badminschemaCoresalutation extends \B2b\Models\BaseModel implements B2bB2badminschemaCoresalutationInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoresalutationInterface*/
    ...
    const CONST_TABLE = "core_salutation";
