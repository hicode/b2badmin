...
abstract class B2bB2badminschemaCoreavailablecodes extends \B2b\Models\BaseModel implements B2bB2badminschemaCoreavailablecodesInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoreavailablecodesInterface*/
                    ...
                    public function getMyowner()
                    {
                        ...
                        * Set myowner.
                        *@param string $myowner    
                        *@return B2bB2badminschemaCoreavailablecodesInterface*/
                         public function setMyowner($myowner) 
                        {      
                            $this->myowner = (string) $myowner;
                            return $this;
                        }    
                            /**
                                * @var int
                    ...
                    public function getMypage()
                    {
                        ...
                        *@param string $mypage    
                        *@return B2bB2badminschemaCoreavailablecodesInterface*/
                         public function setMypage($mypage) 
                        {      
                            $this->mypage = (string) $mypage;
                            return $this;
                        }    
                            /**
                                * @var string
                    ...
                    public function getMymethod()
                    {
                        ...
                        *@return B2bB2badminschemaCoreavailablecodesInterface*/
                         public function setMymethod($mymethod) 
                        {      
                            $this->mymethod = (string) $mymethod;
                            return $this;
                        }
    ...
    const CONST_TABLE = "core_available_codes";
