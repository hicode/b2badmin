...
abstract class B2bB2badminschemaCoreavailabletaxes extends \B2b\Models\BaseModel implements B2bB2badminschemaCoreavailabletaxesInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoreavailabletaxesInterface*/
                    ...
                    public function getDtfrom()
                    {
                        ...
                        *@param string $dtfrom    
                        *@return B2bB2badminschemaCoreavailabletaxesInterface*/
                         public function setDtfrom($dtfrom) 
                        {      
                            $this->dtfrom = (string) $dtfrom;
                            return $this;
                        }    
                            /**
                                * @var string
                    ...
                    public function getDtuntil()
                    {
                        ...
                        *@return B2bB2badminschemaCoreavailabletaxesInterface*/
                         public function setDtuntil($dtuntil) 
                        {      
                            $this->dtuntil = (string) $dtuntil;
                            return $this;
                        }
    ...
    const CONST_TABLE = "core_available_taxes";
