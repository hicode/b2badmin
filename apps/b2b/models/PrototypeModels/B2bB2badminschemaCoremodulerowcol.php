...
abstract class B2bB2badminschemaCoremodulerowcol extends \B2b\Models\BaseModel implements B2bB2badminschemaCoremodulerowcolInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoremodulerowcolInterface*/
                    ...
                    public function getJobremarks()
                    {
                        ...
                        * 
                             /**
                                * @return int
                            */  
                    public function getFkmodulerow()
                    {
                        return $this->fkmodulerow;
                    }  /**
                        * Set fkmodulerow.
                        *@param int $fkmodulerow    
                        *@return B2bB2badminschemaCoremodulerowcolInterface*/
                         public function setFkmodulerow($fkmodulerow) 
                        {      
                            $this->fkmodulerow = (int) $fkmodulerow;
                            return $this;
                        }    
                            /**
                                * @var int
                    ...
                    public function getColwidth()
                    {
                        ...
                        * 
                             /**
                                * @return string
                            */  
                    public function getColheight()
                    {
                        return $this->colheight;
                    }  /**
                        * Set colheight.
                        *@param string $colheight    
                        *@return B2bB2badminschemaCoremodulerowcolInterface*/
                         public function setColheight($colheight) 
                        {      
                            $this->colheight = (string) $colheight;
                            return $this;
                        }    
                            /**
                                * @var string
                    ...
                    public function getColcss()
                    {
                        ...
                        *@param string $colcss    
                        *@return B2bB2badminschemaCoremodulerowcolInterface*/
                         public function setColcss($colcss) 
                        {      
                            $this->colcss = (string) $colcss;
                            return $this;
                        }    
                            /**
                                * @var string
    ...
    const CONST_TABLE = "core_module_row_col";
