...
abstract class B2bB2badminschemaCoreviewtablefield extends \B2b\Models\BaseModel implements B2bB2badminschemaCoreviewtablefieldInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoreviewtablefieldInterface*/
    ...
    const CONST_TABLE = "core_view_table_field";
