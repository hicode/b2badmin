...
abstract class B2bB2badminschemaVfcrmtrainerm extends \B2b\Models\BaseModel implements B2bB2badminschemaVfcrmtrainermInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfcrmtrainermInterface*/
    ...
    const CONST_TABLE = "vf_crm_trainer_m";
