...
abstract class B2bB2badminschemaCorecountry extends \B2b\Models\BaseModel implements B2bB2badminschemaCorecountryInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCorecountryInterface*/
    ...
    const CONST_TABLE = "core_country";
