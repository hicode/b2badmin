...
abstract class B2bB2badminschemaCoresitetable extends \B2b\Models\BaseModel implements B2bB2badminschemaCoresitetableInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoresitetableInterface*/
                    ...
                    public function getFktbl()
                    {
                        ...
                        *@param float $fktbl    
                        *@return B2bB2badminschemaCoresitetableInterface*/
                         public function setFktbl($fktbl) 
                        {      
                            $this->fktbl = (float) $fktbl;
                            return $this;
                        }    
                            /**
                                * @var string
    ...
    const CONST_TABLE = "core_site_table";
