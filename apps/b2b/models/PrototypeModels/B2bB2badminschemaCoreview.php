...
abstract class B2bB2badminschemaCoreview extends \B2b\Models\BaseModel implements B2bB2badminschemaCoreviewInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoreviewInterface*/
                    ...
                    public function getDdlcmd()
                    {
                        ...
                        *@param string $ddlcmd    
                        *@return B2bB2badminschemaCoreviewInterface*/
                         public function setDdlcmd($ddlcmd) 
                        {      
                            $this->ddlcmd = (string) $ddlcmd;
                            return $this;
                        }    
                            /**
                                * @var string
                        ...
                        * 
                             /**
                                * @return string
                            */  
                    public function getDdlcmdfe()
                    {
                        return $this->ddlcmdfe;
                    }  /**
                        * Set ddlcmdfe.
                        *@param string $ddlcmdfe    
                        *@return B2bB2badminschemaCoreviewInterface*/
                         public function setDdlcmdfe($ddlcmdfe) 
                        {      
                            $this->ddlcmdfe = (string) $ddlcmdfe;
                            return $this;
                        }    
                            /**
                                * @var string
                    ...
                    public function getDbviewname()
                    {
                        ...
                        * 
                             /**
                                * @return string
                            */  
                    public function getDbviewnamefe()
                    {
                        return $this->dbviewnamefe;
                    }  /**
                        * Set dbviewnamefe.
                        *@param string $dbviewnamefe    
                        *@return B2bB2badminschemaCoreviewInterface*/
                         public function setDbviewnamefe($dbviewnamefe) 
                        {      
                            $this->dbviewnamefe = (string) $dbviewnamefe;
                            return $this;
                        }
