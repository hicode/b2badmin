...
abstract class B2bB2badminschemaVfpluginnoavailableparamsjsonm extends \B2b\Models\BaseModel implements B2bB2badminschemaVfpluginnoavailableparamsjsonmInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfpluginnoavailableparamsjsonmInterface*/
    ...
    const CONST_TABLE = "vf_plugin_no_available_params_json_m";
