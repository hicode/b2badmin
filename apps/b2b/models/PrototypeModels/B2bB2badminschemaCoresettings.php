...
abstract class B2bB2badminschemaCoresettings extends \B2b\Models\BaseModel implements B2bB2badminschemaCoresettingsInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaCoresettingsInterface*/
    ...
    const CONST_TABLE = "core_settings";
