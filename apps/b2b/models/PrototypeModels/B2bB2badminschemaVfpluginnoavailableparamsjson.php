...
abstract class B2bB2badminschemaVfpluginnoavailableparamsjson extends \B2b\Models\BaseModel implements B2bB2badminschemaVfpluginnoavailableparamsjsonInterface {
    ...
    public function beforeValidationOnUpdate()
    {
        parent::beforeValidationOnUpdate();
                    ...
                    public function getId()
                    {
                        ...
                        * Set id.
                        *@param int $id    
                        *@return B2bB2badminschemaVfpluginnoavailableparamsjsonInterface*/
    ...
    const CONST_TABLE = "vf_plugin_no_available_params_json";
