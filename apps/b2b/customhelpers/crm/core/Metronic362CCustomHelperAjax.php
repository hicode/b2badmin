...
class Metronic362CCustomHelperAjax extends \Phalcon\Tag {

    public static function get_div_ajax_large() {
        $di = \Phalcon\DI::getDefault();
        $assetspath = $di->controller_params_array['publicpath'].'/'.$di->controller_params_array['template']['template_admin_path_with_assets_path'];
